        ...
        <div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" data-columns="<?php echo esc_attr( $columns ); ?>" style="">
            <figure class="woocommerce-product-gallery__wrapper">
                ...
                $html  = '<div data-thumb="' . esc_url( $full_size_image[0] ) . '" class="woocommerce-product-gallery__image">'
                       .     '<a itemprop="image" class="woocommerce-main-image cloud-zoom" href="'.esc_url( $full_size_image[0] ).'">';
                $html .=  '<img src="' . esc_url( $full_size_image[0] ) . '" alt="Image" />'; //get_the_post_thumbnail( $post->ID, 'shop_single', $attributes );
                $html .= '</a></div>';
